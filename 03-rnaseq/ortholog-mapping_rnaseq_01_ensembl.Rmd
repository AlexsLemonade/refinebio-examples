...
Here, you can find the same files you would find at the FTP server linked above.
...
mouse_genes <- readr::read_tsv(file.path(
...
*This is not at all straightforward!* (see, for just one example, https://doi.org/10.1093/bioinformatics/btaa468) [@Stamboulian2020].
