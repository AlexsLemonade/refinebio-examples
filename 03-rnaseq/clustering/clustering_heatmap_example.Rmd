...
## 3) Define a minimum counts cutoff

We are going to do some pre-filtering to keep rows with 10 or more reads total.
...
```{r}
# Perform normalization on the values in the `DESeqDataSet` object
ntd <- normTransform(dds)
```


## 5) Choose genes of interest
