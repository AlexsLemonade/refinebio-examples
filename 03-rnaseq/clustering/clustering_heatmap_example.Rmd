...
For this example analysis, we will use this [acute myeloid leukemia sample dataset](https://alexslemonade.github.io/refinebio-examples/clustering/data/SRP070849.tsv).
...
In this chunk of code, we will specify the `refinebio-treatment` variable to label our experimental groups because it is included in the experimental design as noted in the accompanying [paper](https://pubmed.ncbi.nlm.nih.gov/28193779/).[@AML]
...
annotation_df <- metadata %>%
  ...
  # The `pheatmap` function requires that the rownames of our annotation object matches the column names of our `DESeaDataSet` object
...
For more complex heatmaps, you may want to take a look at:

- [ComplexHeatmap Complete Reference Manual](https://jokergoo.github.io/ComplexHeatmap-reference/book/) [@complex-heatmaps]
