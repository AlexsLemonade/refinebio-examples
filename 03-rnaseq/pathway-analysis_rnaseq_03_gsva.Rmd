...
We want a list where each element of the list is a vector that contains the Entrez gene IDs from the `entrez_gene` column that are in the particular gene set from the `gs_name` column.
...
mapped_df <- data.frame(
  ...
  dplyr::inner_join(normalized_df, by = c("Ensembl" = "ensembl_id"))
```
