...
This notebook illustrates one way that you can use harmonized RNA-seq data from refine.bio to perform Principal Component Analysis and plot the scores using ggplot2. 
