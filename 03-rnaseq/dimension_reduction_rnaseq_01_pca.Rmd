...
We are plotting PCA using the variables `refinebio_treatment` and `refinebio_disease` for labels since they are central to the androgen deprivation therapy (ADT) based hypothesis in the [original paper](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6210624/) [@ADT-Prostate-Cancer]
...
ggplot(pcaData, aes(
  x = PC1,
  y = PC2,
  color = refinebio_treatment, # This will label points with different colorsr for each `refinebio_disease` group
