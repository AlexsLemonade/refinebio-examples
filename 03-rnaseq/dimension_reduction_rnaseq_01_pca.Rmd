...
In the plot above, it is hard to distinguish the different `refinebio_treatment` values which contain the data on whether or not samples have been treated with ADT versus the `refinebio_disease` values which refer to the method by which the samples were obtained from patients.
...
annotated_pca_plot <- ggplot(
  ...
  aes(
    ...
    # This will label points with different colors for each `refinebio_disease` group
