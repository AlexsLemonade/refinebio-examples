...
There are 9102 NA's in our data frame, which means that 9088 out of the 31882 Ensembl IDs did not map to Entrez IDs.
...
We do not have a particular reason to choose one over the other, so let's just keep the first mapped Entrez ID that comes up.
