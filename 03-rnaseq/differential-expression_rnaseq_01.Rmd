...
Here we will use `lfcShrink()` function to obtain "shrunk" log fold change estimates based on negative binomial distribution. 
...
Now let's take a peak at what our results table looks like. 
