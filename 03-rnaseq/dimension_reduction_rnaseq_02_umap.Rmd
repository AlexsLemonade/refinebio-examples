...
In this chunk, we are are going to use the `ggplot` function to plot our normalized UMAP scores.
...
Now we are going to add a variable to our plot for annotation.
...
- [A nice explanation and comparison of many different dimensionality reduction techniques that you may encounter](https://rpubs.com/Saskia/520216) [@dimension-reduction-explained]
