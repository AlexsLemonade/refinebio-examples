...
```{r}
# Check if the gene expression matrix file is where the file path stored in `data_file` says
file.exists(data_file)

# Check if the metadata file is where the file path stored in `metadata_file` says
