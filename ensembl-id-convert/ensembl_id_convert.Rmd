...
if (!dir.exists("results")) { # Replace with path to desired results directory
  dir.create("results") # Replace with path to desired results directory
}
```
...
# this data frame
df <- readr::read_tsv(file.path("data", # Replace with path to your data directory
...
readr::write_tsv(annot.df, file.path("results", # Replace with path to your results directory
                                     "SRP056136wGeneSymbols.tsv" # Replace with a relevant output file name
                                     ))
```
