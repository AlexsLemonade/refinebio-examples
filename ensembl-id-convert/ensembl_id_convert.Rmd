...
This notebook is an example annotation workflow for data obtained from refine.bio
...
Although this example script uses Ensembl IDs from Zebrafish,
 (<i>Danio rerio</i>), to obtain gene symbols this script can be easily 
