...
Let's use `ggplot` to see what module 52's eigengene looks like between treatment groups. 

```{r}
labeled_eigengenes_df %>% 
  ggplot2::ggplot(ggplot2::aes(x = refinebio_treatment, 
                               y = ME52, 
