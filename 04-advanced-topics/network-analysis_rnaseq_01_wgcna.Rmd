...
By providing a soft-threshold power parameter, we can guide it on {{I still can't figure out what power actually represents here}}
...
The `blockwise` part refers to that these calculations will be done on chunks of your data at a time to help with computing resources.
...
```
If you want to know which of your genes make up which modules, you can look at the `$colors` slot. 
...
## Take a look at eigengenes with your metadata
...
## Visualize how correlated these eigengenes are
