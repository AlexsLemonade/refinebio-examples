...
As output, WGCNA gives groups of co-expressed genes as well as an eigengene x sample matrix (where eigengenes contain the summarized variance for a group of co-expressed genes) [@Alter2000; @Langfelder2007]. 
