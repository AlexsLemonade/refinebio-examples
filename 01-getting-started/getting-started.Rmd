...
- An R Notebook which consists of:
     - An R markdown (Rmd) file(s) that you can use in RStudio to run the analysis and contains it's own "getting started" section which describes how to download the example dataset from refinebio. 
