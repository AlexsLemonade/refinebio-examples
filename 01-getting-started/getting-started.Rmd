...
output:   
  html_notebook: 
    ...
    toc_float: true
navbar:
  title: "Refinebio-examples"
  left:
    - text: "Microarray"
      href: 02-microarray/intro-to-microarray.nb.html
    - text: "RNA-seq"
      href: 03-rnaseq/intro-to-rna-seq.nb.html
    - text: "Advanced Topics"
      href: 04-advanced-topics/intro-to-advanced-topics.nb.html
---
...
* [**Bioconductor**](https://bioconductor.org/install/) for installing packages from this package repository [@Bioconductor].    
* [**tidyverse**](https://www.tidyverse.org/) - we opt for using tidyverse packages for handling and cleaning the data [@tidyverse].    
* [**devtools**](https://cran.r-project.org/web/packages/devtools/readme/README.html)
will be required for installing some packages from GitHub [@devtools].  
