...
```{r  Write results}
readr::write_tsv(stats, file.path("results", # Replace with path to your results directory
...
```{r}
# Create volcano plot 
voc.plot <- volcanoplot(fit, main = "Volcano Plot SRP078441") # Replace title with one relevant to your data

# Save plot to png
png(file.path("plots", # Replace with path to your output plots directory
              "volcano_plot_SRP078441.png" # Replace with a plot name relevant to your data
              ))
volcanoplot(fit, main = "Volcano Plot SRP078441") # Replace title with one relevant to your data
dev.off()
```
