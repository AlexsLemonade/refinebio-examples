...
metadata <- read.delim("../data/metadata_GSE71270.tsv", header = TRUE)

# Read in data tsv file
df <- read.delim("../data/GSE71270.tsv", header = TRUE, row.names = 1,
...
des.mat <- c(1, 0)[metadata$genotype.variation[tmp]]
```
...
```{r  Write results}
write.table(stats, file = "GSE71270limmaResults.tsv", sep = "\t", quote = FALSE)
```
