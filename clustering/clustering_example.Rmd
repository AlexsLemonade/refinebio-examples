...
```{r Install and attach the ComplexHeatmap library, eval=FALSE}
...
metadata <- read.delim(file.path("data", "metadata_GSE12955.tsv"), header=TRUE, 
                       stringsAsFactors = FALSE)

# Read in data tsv file
df <- read.delim(file.path("data", "GSE12955.tsv"), header=TRUE, row.names= 1, 
                 stringsAsFactors = FALSE)
```
...
# Open a png file
png(file.path("results", "HeatmapGSE12955.png"))
