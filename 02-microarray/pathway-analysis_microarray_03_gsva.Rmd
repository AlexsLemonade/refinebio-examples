...
Keep in mind that the `mx.diff = TRUE` argument that we supplied to the `gsva()` function in the previous section means the GSVA output scores should be normally distributed, which will be evident in our downstream analyses.
...
```{r}
top_pathway_annotated_results_df <- gsva_results %>%
