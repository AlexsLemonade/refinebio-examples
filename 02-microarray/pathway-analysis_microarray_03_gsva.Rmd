...
Let's make a violin plot to look at the differences between the disease status and treatment groups (found in the `refinebio_disease` and `refinebio_treatment` columns, respectively), using our GSVA scores.
...
annotated_results_df <- gsva_results %>%
  ...
  # Now we need to create a column variable to combine and store the information
