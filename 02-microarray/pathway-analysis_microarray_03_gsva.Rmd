...
The `GSE37418` folder has the data and metadata TSV files you will need for this example analysis.
...
In this analysis, we will be using the [`GSVA`](https://www.bioconductor.org/packages/release/bioc/html/GSVA.html) package to perform GSVA, the [`qusage`](https://www.bioconductor.org/packages/release/bioc/html/qusage.html) package to read in the GMT file containing the gene set data, and the [`pheatmap`](https://cran.r-project.org/web/packages/pheatmap/index.html) package to create a heatmap for visualization of the GSVA scores [@Hanzelmann2013; @Meng2019; @Slowikowski2017].
