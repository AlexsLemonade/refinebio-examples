...
The jitter plot we make later on involves some randomness. 
As is good practice when our analysis involves randomness, we will [set the seed](TODO: link to glossary about setting the seed).
