...
# Create Q-Q plot
qq_plot <- qqt(fit$t, pch = 16, cex = 0.2); abline(0,1)

# Save plot to png
png(file.path(plots_dir,
              "GSE71270_qqplot.png" # Replace file name with a relevant output plot name
              ))
qqt(fit$t, pch = 16, cex = 0.2); abline(0,1) # Print out the same thing we did previously
dev.off()
```
...
```{r}
readr::write_tsv(stats, file.path(results_dir,
