...
[This notebook](https://alexslemonade.github.io/refinebio-examples/02-microarray/clustering/clustering_example.nb.html) uses the Bioconductor R package `ComplexHeatmap` for clustering and creating a heatmap.
