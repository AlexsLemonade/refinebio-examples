...
This example is one of pathway analysis module set, we recommend looking at the [pathway analysis table beloow](#how-to-choose-a-pathway-analysis) to help you determine which pathway analysis method is best suited for your purposes.
...
We highly recommend taking a look at Ten Years of Pathway Analysis: Current Approaches and Outstanding Challenges from @Khatri for a more comprehensive overview and reading the primary publications and documentation of the methods and sources we will introduce below.
