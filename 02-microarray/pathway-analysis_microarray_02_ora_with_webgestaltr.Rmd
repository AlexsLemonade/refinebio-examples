...
go_enrichment_results <-
  WebGestaltR(
    enrichMethod = "ORA",
    organism = "hsapiens",
    enrichDatabase = "geneontology_Biological_Process", # What categories we'd like enrichment results for
    interestGene = upregulated_genes, # The vector of our genes of interest
    interestGeneType = "ensembl_gene_id",
    referenceGene = all_genes, # The vector of all the genes originally in our set
    referenceGeneType = "ensembl_gene_id",
    outputDirectory = results_dir, # Replace with the directory you would like your results saved to
...
## Read in a results table

Let's take a look at one of the results tables look like by importing it into R. 

```{r}
results_df <- readr::read_delim(
  file.path(
    results_dir,
    "Project_GSE37418_up_SHH_lfc2_fdr0_05",
    "enrichment_results_GSE37418_up_SHH_lfc2_fdr0_05.txt"
  ),
  delim = "\t"
)
```
...
In the `link` column, you can use the links to see more information about a particular GO term.
Take a look at the link for the top result, `translational initiation`: http://amigo.geneontology.org/amigo/term/GO:0006413
