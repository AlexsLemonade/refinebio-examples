...
The overexpressing CREB group samples are have much higher expression values for ENSDARG00000104315 than the control samples do. 
...
volcano_plot # Print out the same thing we did above.
