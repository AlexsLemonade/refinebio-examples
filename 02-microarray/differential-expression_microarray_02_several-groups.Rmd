...
```{r}
summary(as.factor(metadata$subgroup)) # Notice we are coercing this to a factor
# so we can see the counts per group, `subgroup`
...
We're diving by three in this expression so that each is contrasted to the average of the other three groups. 
