...
Microarrays can be categorized by their probe chemistry: Affymetrix GeneChips, Illumina Beadarray and etc. all of which supported on refine.bio.
But, refine.bio only supports single-color arrays, although there are two-color arrays, so our examples and advice are generally from the perspective of using single-color array 
