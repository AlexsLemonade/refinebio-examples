...
A common and simple reason you may not see your gene of interest is that the microarrray chip did not originally have probes designed to it. 

Refine.bio also uses [Brainarray packages](http://brainarray.mbni.med.umich.edu/Brainarray/Database/CustomCDF/) to annotate the microarray probe data for microarray platforms that have this available [@Dai2005]. 
...
One additionaly reason you may not see a gene of interest applies only if you are refine.bio's [aggregatee by species](https://docs.refine.bio/en/latest/main_text.html#aggregations) option.
