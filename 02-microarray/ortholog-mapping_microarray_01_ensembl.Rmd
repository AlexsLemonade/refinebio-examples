...
There are the same files you would get from the link above.
...
Although we haven't filter down to zero multi-mapped genes, we were able to filter down to a more reasonable number of _reliable_ mappings.
