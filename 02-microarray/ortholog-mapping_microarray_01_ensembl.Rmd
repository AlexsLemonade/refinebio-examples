...
zebrafish_hgnc_file <- file.path(
  data_dir,
  # The the file will have locally
...
(Notice that we also still have some duplicate Ensembl ID/human symbol pairs here because the `support` column was different in the original data set!
