...
```{r}
kegg_mouse_list[[grep("POLYMERASE", # Replace with a word (case sensitive) or phrase that would filter in your desired pathway(s)
...
mouse_file <- file.path("gene-sets", # Replace with path to desired output directory
