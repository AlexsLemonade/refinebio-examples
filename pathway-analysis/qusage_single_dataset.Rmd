...
Because our gene sets use gene symbols and our expression data uses Ensembl 
IDs, we need to do a conversion.
...
This particular accession (`GSE75574`) is a SuperSeries comprised of experiments
in multiple tissues from multiple mouse strains. 
We're interested in white adipose tissue for all strains.
...
default).
Unfortunately the p-value color scheme is red-green.
