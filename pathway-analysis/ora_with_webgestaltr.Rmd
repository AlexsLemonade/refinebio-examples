...
using some cutoff) has shares more or less genes with gene sets/pathways than
...
perform poorly with 7 samples or less in each group (Yaari et al. _NAR_. 2013.).
...
```{r}
# TODO: possibly updated commit hash once 
# https://github.com/AlexsLemonade/refinebio-examples/pull/46 lands
dge_df <- readr::read_tsv("https://github.com/AlexsLemonade/refinebio-examples/raw/55ccd5819d3cfabaeb9c64378253ba235c8e2d18/validate-differential-expression/results/GSE37418_limma_results.tsv")
```
...
Put another way, if a gene is not _measured_, it can not possibly be in
...
processes as our knowledgebase / source of gene sets.
...
go_enrichment_results <- 
  WebGestaltR(enrichMethod = "ORA",
              ...
              projectName = "GSE37418_up_SHH_lfc2_fdr0.05")
```

As noted in the messages from `WebGestaltR`, the results are in
`results/Project_GSE37418_up_SHH_lfc2_fdr0.05`.
The HTML report is at 
[`results/Project_GSE37418_up_SHH_lfc2_fdr0.05/Report_GSE37418_up_SHH_lfc2_fdr0.05.html`](./results/Project_GSE37418_up_SHH_lfc2_fdr0.05/Report_GSE37418_up_SHH_lfc2_fdr0.05.html).
