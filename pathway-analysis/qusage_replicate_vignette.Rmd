...
expression_file <- file.path(data_dir,
                             "GSE30550",  # Replace with name of your unzipped folder
...
```{r}
pathway_index <- 
  which(names(kegg_genesets) == "KEGG_T_CELL_RECEPTOR_SIGNALING_PATHWAY") # Replace with desired pathway -- names of pathways can be seen using the `names(kegg_genesets)` function
```
