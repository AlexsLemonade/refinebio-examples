...
matrix.file.name <- file.path(data_dir,
...
geo.data <-  GEOquery::getGEO("GSE37382", # Replace with the GEO Accession ID relevant to your txt file
...
author.df <- readr::read_tsv(file.path(data_dir,
                                       "GSE37382_series_matrix.txt" # Replace with name of your gene matrix file
                                       ), 
                             comment = "!") %>% 
