...
Here we will compare differential expression results we've previously obtained for <INSERT INFO ABOUT COMPARISON> to results from a refine.bio dataset.
We generated this in <link to notebook>. These data are originally from <CITATION, etc.>.
