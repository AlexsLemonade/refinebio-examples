...
```{r}
# Make png to save plot to
png(file.path("plots", "up-regulated_venn_northcott_vs_robinson.png"))
...
```{r}
# Make png to save plot to
png(file.path("plots", "down-regulated_venn_northcott_vs_robinson.png"))
