...
If you want to run a spell check of all `.Rmd` files locally, you can use run `Rscript components/spell-check.R` and it will print out the same type of file in the `components` folder.
