...
*Purpose*: This notebook illustrates how to assess batch effects and correct for
them with `limma`. 
...
for many datasets. 
However, it is good practice to assess for batch effects, especially if your 
